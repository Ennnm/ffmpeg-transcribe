...
const speechToText = new SpeechToTextV1({
  ...
  // serviceUrl:
  //   'https://api.au-syd.speech-to-text.watson.cloud.ibm.com/instances/31772479-c3bf-4b4d-b14a-abffd0d43d11',
});
...
app.get('/extract', (req, res) => {
  (async () => {
    ...
    ffmpeg.FS(
      'writeFile',
      'shennan_video.mp4',
      await fetchFile('./shennan_video.mp4')
    );
    await ffmpeg.run(
      '-i',
      'shennan_video.mp4',
...
app.get('/transcribe', (req, res) => {
  ...
  recognizeStream.on('close', function (event) {
    onEvent('Close:', event);
    fs.writeFile('./transcript2.txt', JSON.parse(transcripts.join('')));
  });
